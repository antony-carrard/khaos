...
-   24 jetons ville \"Bicéphales\".

-   24 jetons ville \"Le Bâtisseur\".
...
1.  Le joueur choisit ce qu'il veut récolter entre les ressources, la
...
3.  À la fin du tour, chaque joueur jette ses tuiles encore en main et
    en re-pioche 3 autres.

La partie se termine quand le paquet de tuiles est vide. Les joueurs
terminent alors leur dernier tour et on procède au comptage des points.
...
-   **Augmenter la tuile d'un niveau** :
    ...
    **uniquement si elle est vide ou si c'est un de ses propres Village
    ...
    moitié du prix de construction de ce village (depuis la réserve).
    Ici, la destruction du village ne compte pas comme action.\

-   **Destruction d'un village adverse** :

    Le joueur peut détruire un village adverse. Pour cela, les **3**
    conditions suivantes doivent être réunie.\

    1.  Le village adverse doit être sur une tuile adjacente à une tuile
        contrôlée par le joueur actif.

    2.  La tuile doit être de niveau égal ou inférieur à la tuile
        contrôlée par le joueur actif.
...
-   1 pt par ville construite sur une **plaine**, 2 pts par ville sur
    les **collines** et 3 pts par ville construite sur une **montagne**.

-   1 pt par **paire** de **ressources** dans sa réserve.

-   1 pt par **paire** de **ferveur** dans sa réserve.

-   1 pt par **gloire** dans sa réserve.

-   points des \"territoires\"

-   points de la carte Objectifs
...
-   **Pouvoir majeur** :
    ...
    Il peut également faire une 2e récolte au tour en cours. Coût en
    ferveur : 5
...
-   **Pouvoir majeur** :
    ...
    Le Bâtisseur peut détruire le bâtiment d'un adversaire au tour en
    cours sans devoir lui rembourser quoi que ce soit. Coût en ferveur :
    6
...
-   **Pouvoir mineur** :
    ...
    Augia peut changer le type de ses propres Tuiles, peu importe le
    genre, au tour en cours. Coût en ferveur : 2
...
-   **Pouvoir majeur** :
    ...
    Il peut diminuer une Tuile d'un niveau, au tour en cours, sans y
    détruire le Bâtiment éventuellement présent. Coût en ferveur : 4
